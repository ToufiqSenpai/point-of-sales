<div class="fixed top-0 left-0 right-0 bottom-0 z-40 duration-300" style="background-color: rgba(0,0,0,0); visibility: hidden">
  <form method="POST" class="w-full h28 max-w-md max-mobile:max-w-[94%] bg-white rounded-md absolute top-[50%] left-[50%] duration-300 opacity-0" style="transform: translate(-50%,-30%)">
